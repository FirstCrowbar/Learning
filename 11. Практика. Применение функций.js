...
function writeYourGenres() {
    ...
    for (let i = 0; i < 3; i++) {       /* Условие цикла: операнд i равен нулю, цикл повторяется пока i < 3, при каждой итерации происходит инкремент i */
        const genre = prompt('Ваш любимый жанр под номером ' + numbers++); /* в вопросе конкатенируем перем. numbers */
        personalMovieDB.genres[numbers - 2] = genre;    /* записываем ответы пользователя в массив */
    }
}
writeYourGenres();
